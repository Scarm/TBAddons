...
function BaseGroup:MovingPlus()
	local res = self:Moving(false)
	if res:Any() then
		return res
	end
	return self:Aura("Покорение безумию", "mine", "self")
end
...
function bot:OnUpdate(g, list, modes)
	...
	if modes.toggle.AoE then
		list:Cast( "Иссушение разума", g.target:MovingPlus():CanUse("Иссушение разума"):Best() )
		return list:Execute()
	end

	list:Cast( "Извержение Бездны", g.target:CanUse("Стрела бездны", {"Пытка разума", "Иссушение разума"}):Best() )

	list:Cast( "Поток Бездны", g.target:CanUse("Поток Бездны", {"Пытка разума", "Иссушение разума"}):Energy("<", 25):Moving(false):Enabled("Поток Бездны"):Best() )
	list:Cast( "Поток Бездны", g.target:CanUse("Поток Бездны", {"Пытка разума", "Иссушение разума"}):Energy("<", 25):Moving(false):Toggle("Burst"):Best() )

	list:Cast( "Прикосновение вампира", g.target:MovingPlus():CanUse("Прикосновение вампира", {"Пытка разума", "Иссушение разума"}):Aura("Облик Бездны", "mine", "inverse", "self"):Aura("Прикосновение вампира", "mine", "inverse", {time=6, bound=">"}):LastCast("Прикосновение вампира", false):Talent("Наследие Бездны"):Enabled("Извержение Бездны"):Energy(">", 85):Best() )
	list:Cast( "Прикосновение вампира", g.target:MovingPlus():CanUse("Прикосновение вампира", {"Пытка разума", "Иссушение разума"}):Aura("Облик Бездны", "mine", "inverse", "self"):Aura("Прикосновение вампира", "mine", "inverse", {time=6, bound=">"}):LastCast("Прикосновение вампира", false):Talent("Наследие Бездны"):Toggle("Burst"):Energy(">", 85):Best() )
	list:Cast( "Слово Тьмы: Боль", g.target:CanUse("Слово Тьмы: Боль", {"Пытка разума", "Иссушение разума"}):Aura("Облик Бездны", "mine", "inverse", "self"):Aura("Слово Тьмы: Боль", "mine", "inverse", {time=6, bound=">"}):Enabled("Извержение Бездны"):Talent("Наследие Бездны"):Energy(">", 85):Best() )
	list:Cast( "Слово Тьмы: Боль", g.target:CanUse("Слово Тьмы: Боль", {"Пытка разума", "Иссушение разума"}):Aura("Облик Бездны", "mine", "inverse", "self"):Aura("Слово Тьмы: Боль", "mine", "inverse", {time=6, bound=">"}):Toggle("Burst"):Talent("Наследие Бездны"):Energy(">", 85):Best() )
	...
	list:Cast( "Прикосновение вампира", g.target:MovingPlus():CanUse("Прикосновение вампира", {"Пытка разума", "Иссушение разума"}):Aura("Облик Бездны", "mine", "inverse", "self"):Aura("Прикосновение вампира", "mine", "inverse", {time=6, bound=">"}):LastCast("Прикосновение вампира", false):Enabled("Извержение Бездны"):Energy(">", 100):Best() )
	list:Cast( "Прикосновение вампира", g.target:MovingPlus():CanUse("Прикосновение вампира", {"Пытка разума", "Иссушение разума"}):Aura("Облик Бездны", "mine", "inverse", "self"):Aura("Прикосновение вампира", "mine", "inverse", {time=6, bound=">"}):LastCast("Прикосновение вампира", false):Toggle("Burst"):Energy(">", 100):Best() )
	list:Cast( "Слово Тьмы: Боль", g.target:CanUse("Слово Тьмы: Боль", {"Пытка разума", "Иссушение разума"}):Aura("Облик Бездны", "mine", "inverse", "self"):Aura("Слово Тьмы: Боль", "mine", "inverse", {time=6, bound=">"}):Enabled("Извержение Бездны"):Energy(">", 100):Best() )
	list:Cast( "Слово Тьмы: Боль", g.target:CanUse("Слово Тьмы: Боль", {"Пытка разума", "Иссушение разума"}):Aura("Облик Бездны", "mine", "inverse", "self"):Aura("Слово Тьмы: Боль", "mine", "inverse", {time=6, bound=">"}):Toggle("Burst"):Energy(">", 100):Best() )
  ...
  list:Cast( "Взрыв разума", g.target:CanUse("Взрыв разума", {"Пытка разума", "Иссушение разума"}):Moving(false):Best() )
	...
	list:Cast( "Прикосновение вампира", g.target:MovingPlus():CanUse("Прикосновение вампира", {"Пытка разума", "Иссушение разума"}):Aura("Прикосновение вампира", "mine", "inverse", {time=1.5, bound=">"}):LastCast("Прикосновение вампира", false):Best() )
  ...
  list:Cast( "Пытка разума", g.target:CanUse("Пытка разума"):MovingPlus():Best() )
