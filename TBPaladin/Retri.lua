...
function PaladinRetri:OnUpdate(g, list, modes)
	...
	if modes.Rotation == "Single" then
		...
		list:Cast( "Правосудие", g.targets:CanUse("Правосудие"):Aura("Гнев карателя", "mine", "self", nil):Best() )
		list:Cast( "Божественная буря", g.targets:CanUse("Божественная буря"):Aura("Воин богов", "mine", "self", nil):Aura("Гнев карателя", "mine", "self", nil):InPaladinRange():Best() )
