...
function DruidBalance:OnUpdate(g, list, modes)
	...
	list:Cast( "Омоложение",   g.player:CanUse("Омоложение"):Aura("Омоложение", "mine", nil, "inverse", 3):HealingRange(95,95):MinHP() );
	--list:Cast( "Омоложение",   g.player:CanUse("Омоложение"):Aura("Омоложение", "mine", nil, "inverse", 3):MinHP() );
