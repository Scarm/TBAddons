...
function bot:PartyHeal(g, list, modes)
	...
	-- Сливаем протухающие проки  и кд
	list:Cast( "Восстановление", 
			g.party:CanUse("Восстановление")
			:Moving(false)
			:Aura("Ясность мысли", "mine", "self", {time=10, bound="<"}, {stacks=3, bound=">"})
			:HP("<",80)
			:LastCast("Восстановление", false)
			:MinHP() )
	list:Cast( "Восстановление", 
			g.party:CanUse("Восстановление")
			:Moving(false)
			:Aura("Ясность мысли", "mine", "self", {time=7, bound="<"}, {stacks=2, bound=">"})
			:HP("<",80)
			:LastCast("Восстановление", false)
			:MinHP() )
	list:Cast( "Восстановление", 
			g.party:CanUse("Восстановление")
			:Moving(false)
			:Aura("Ясность мысли", "mine", "self", {time=4, bound="<"}, {stacks=1, bound=">"})
			:HP("<",80)
			:LastCast("Восстановление", false, "total")
			:MinHP() )
	
	list:Cast( "Быстрое восстановление", g.party:CanUse("Быстрое восстановление"):Talent("Обилие"):Charges("Быстрое восстановление",2, 10):HP("<",70):MinHP() )
	list:Cast( "Быстрое восстановление", g.mainTank:CanUse("Быстрое восстановление"):Talent("Обилие"):Charges("Быстрое восстановление",2, 10):HP("<",80):MinHP() )
	
	list:Cast( "Быстрое восстановление", g.party:CanUse("Быстрое восстановление"):Talent("Обилие"):Charges("Быстрое восстановление",2, 5):HP("<",80):MinHP() )
	list:Cast( "Быстрое восстановление", g.mainTank:CanUse("Быстрое восстановление"):Talent("Обилие"):Charges("Быстрое восстановление",2, 5):HP("<",90):MinHP() )
	...
	list:Cast( "Звездный поток", g.mainTank:CanUse("Звездный поток"):Mana(">", 90):Moving(false):Best() )
	list:Cast( "Лунный огонь", g.mainTank:CanUse("Лунный огонь"):Aura("Лунный огонь", "mine", "inverse"):Mana(">", 90):Best() )
	list:Cast( "Солнечный огонь", g.mainTank:CanUse("Солнечный огонь"):Aura("Солнечный огонь", "mine", "inverse"):Mana(">", 90):Best() )
	list:Cast( "Солнечный гнев", g.mainTank:CanUse("Солнечный гнев"):Aura("Солнечное могущество", "mine", "self"):LastCast("Солнечный гнев", false):Moving(false):Best() )
	list:Cast( "Лунный удар", g.mainTank:CanUse("Лунный удар"):Aura("Лунное могущество", "mine", "self"):LastCast("Лунный удар", false):Mana(">", 90):Moving(false):Best() )
	list:Cast( "Солнечный гнев", g.mainTank:CanUse("Солнечный гнев"):Moving(false):Best() )
	list:Cast( "Лунный удар", g.mainTank:CanUse("Лунный удар"):Moving(false):Mana(">", 90):Best() )
